 ...
 */
final class Version20201223200025 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE level (id INT AUTO_INCREMENT NOT NULL, multiple INT NOT NULL, max_number INT NOT NULL, target INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
